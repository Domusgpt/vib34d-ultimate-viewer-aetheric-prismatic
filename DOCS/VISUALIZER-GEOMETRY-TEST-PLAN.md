...
- Run `npm run test -- tests/visual-geometry-presets.spec.js --project=chromium` to capture the geometry grids and assert dataset metadata for the faceted, quantum, and holographic systems.
