...
Run `npm run geometry:report` to refresh `DOCS/GEOMETRY-ASSET-STATUS.md`; the generated Markdown snapshot captures geometry counts, icon filenames, and segment totals for reviewers comparing asset updates.
